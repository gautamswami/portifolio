...
const menus = {
  main: `Select a menu:<br><span onclick="handleMenuClick('1')">[1] Who is gautam?</span><br><span onclick="handleMenuClick('2')">[2] Contact me</span><br><span onclick="handleMenuClick('3')">[3] My works</span>`,
  1: `Who is gautam?<br><br>I've been a software developer for several years. My journey into the tech world began by creating web application's and solving complex problems. I channeled my skills into web , application , software development and mangement . This led me to work extensively with web application, a niche where I contributed significantly. <br><br>Following my stint with web application, I delved into the launching my own SAAS. Nowadays, my expertise lies in web application development and management. I proudly created <a href="https://driftcode.in">DRIFTCODE</a>, an organisation that focus on creating web applications.<br><br><span onclick="handleMenuClick('B')">[B] Back</span>`,
  2: `Contact:<br>- Email: <a href="mailto:gautams5974@gmail.com">gautams5974@gmail.com</a><br>- Github: <a href="https://github.com/gautamswami">@gautamswami</a><br><br><span onclick="handleMenuClick('B')">[B] Back</span>`,
  3: `Some of my Projects:<br><br>
- <strong>Material Library</strong>: A web application that is integration on E-learning, E-commerce,Portfolio management,Job portal, Micro website's and a blog portal. <a href="https://materiallibrary.org" target="_blank">[ML LIVE]</a><br>
